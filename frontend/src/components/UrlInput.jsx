...
export default function UrlInput({
    ...
    const processVideo = async () => {
        ...
        try {
            ...
            // Step 1: Fetch transcript from Next.js API
            ...
            const transcript = transcriptData.transcript || rawText;

            // Step 2: Send transcript to FastAPI
            ...
            setStatus(
                err.message || "Unable to process this video."
            );
            setStatusType("error");
    ...
    return (
        <div className="rounded-[22px] border border-slate-200 bg-gradient-to-br from-[#ffffff] to-[#fbfdff] p-4 shadow-sm sm:p-5">
            <div className="mb-3 flex items-center gap-2">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500">
                        Paste a public YouTube link to begin.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-3 lg:flex-row">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        onKeyDown={(e) =>
                            e.key === "Enter" && processVideo()
                        }
                        className="w-full rounded-xl border border-slate-200 bg-white py-3 pl-11 pr-4 text-sm text-slate-700 placeholder:text-slate-400 shadow-inner shadow-slate-100 transition"
                    />
                </div>
            ...
            {loading && (
                <Loader label="Reading transcript and building knowledge base..." />
            )}
        </div>
    );
}